...
function validateAndNextPage() {
  ...
  if (isValid) {
    ...
    setHeatingConsumption(consumptionValue, 'Liter (l)');
    // set into the state
...
<template>
  <div class="container">
    <p class="title">Bitte gib deinen akuellen Jahresverbrauch in Liter an</p>
    <p class="description">
      Den Verbrauch findest du z.B. auf den Rechnungen deines Energieversorgers.
    </p>
    <div class="form-group">
      <p class="label">Jahresverbrauch in Liter</p>
